...
{
public:
    Graph(igraph_t* graph, const vector<double> &edge_weights, const vector<size_t> &node_sizes, const vector<double> &node_self_weights, int correct_self_loops);
    Graph(igraph_t* graph, const vector<double> &edge_weights, const vector<size_t> &node_sizes, const vector<double> &node_self_weights);
    Graph(igraph_t* graph, const vector<double> &edge_weights, const vector<size_t> &node_sizes, int correct_self_loops);
    Graph(igraph_t* graph, const vector<double> &edge_weights, const vector<size_t> &node_sizes);
    Graph(igraph_t* graph, const vector<double> &edge_weights, int correct_self_loops);
    Graph(igraph_t* graph, const vector<double> &edge_weights);
    ...
    vector< pair<size_t, size_t> >* get_neighbour_edges(size_t v, igraph_neimode_t mode);
    vector< size_t >* get_neighbours(size_t v, igraph_neimode_t mode);
    ...
    {
        return igraph_is_directed(this->_graph);
    }
